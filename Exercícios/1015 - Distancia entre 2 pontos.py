...
#Entrada
#O arquivo de entrada contém duas linhas de dados. A primeira linha contém dois valores de ponto flutuante: x1
#y1 e a segunda linha contém dois valores de ponto flutuante x2 y2.
#Saída
